...
/*   Updated: 2018/08/23 15:05:43 by kwiessle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	ft_putnbr_base(sha256->h0, 16, S_16);
	ft_putnbr_base(sha256->h1, 16, S_16);
	ft_putnbr_base(sha256->h2, 16, S_16);
	ft_putnbr_base(sha256->h3, 16, S_16);
	ft_putnbr_base(sha256->h4, 16, S_16);
	ft_putnbr_base(sha256->h5, 16, S_16);
	ft_putnbr_base(sha256->h6, 16, S_16);
	ft_putnbr_base(sha256->h7, 16, S_16);
}

...
/*   Updated: 2018/08/23 15:43:15 by kwiessle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_ssl.h"

void		stdin_compute(t_mdig *env, t_state flag)
{
	t_input		*input;
...
void		mdig_loop(t_mdig *env, char **args)
{
	int		i;
...
void		mdig_engine(char **args, void (*p)(t_input *), char *name)
{
	...
	if (env->entries_len - env->ignored_entries == 2)
	{

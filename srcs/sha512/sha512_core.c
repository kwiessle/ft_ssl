...
/*   Updated: 2018/08/23 14:30:47 by kwiessle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	ft_putbignbr_base(sha512->h0, 16, S_16);
	ft_putbignbr_base(sha512->h1, 16, S_16);
	ft_putbignbr_base(sha512->h2, 16, S_16);
	ft_putbignbr_base(sha512->h3, 16, S_16);
	ft_putbignbr_base(sha512->h4, 16, S_16);
	ft_putbignbr_base(sha512->h5, 16, S_16);
	ft_putbignbr_base(sha512->h6, 16, S_16);
	ft_putbignbr_base(sha512->h7, 16, S_16);
}
